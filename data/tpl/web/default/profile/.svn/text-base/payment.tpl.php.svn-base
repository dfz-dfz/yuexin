...
<div class="js-profile-payment" ng-controller="paymentCtrl" ng-cloak>
	<table class="table we7-table table-hover table-form">
		...
		<tr>
			...
			<td>{{  paysetting.wxapp.has_config === true ? '未配置' : '已配置'  }}</td>
			<td>
				无需设置
			</td>
			<td class="text-center">
				<div class="link-group">
					<a href="javascript:;" data-toggle="modal" data-target="#wxapp">
						{{  paysetting.wxapp.has_config === true ? '修改配置' : '去配置'  }}
					</a>
				</div>
			</td>
		</tr>
	...
	<div class="modal fade" id="wxapp" tabindex="-1" role="dialog" aria-hidden="true">
		<div class="we7-modal-dialog modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
					<div class="modal-title">绑定小程序</div>
				</div>
				<div class="modal-body">
					<div class="we7-form">
						<div class="form-group">
								<label for="" class="control-label col-sm-2">小程序身份标识<br>(appId)</label>
								<div class="form-controls col-sm-10">
									<input type="text" name="" ng-model="paysetting.wxapp.wxappkey" class="form-control" placeholder="">
									<span class="help-block">
										绑定小程序的appid（用于打包小程序的支付实现）
									</span>
								</div>
							</div>
						<div class="form-group">
								<label for="" class="control-label col-sm-2">小程序身份密钥<br>(appSecret)</label>
								<div class="form-controls col-sm-10">
									<input type="text" name="" ng-model="paysetting.wxapp.wxappsecret" class="form-control" placeholder="">
									<span class="help-block">绑定小程序的appSecret（用于打包小程序的支付实现）
									</span>
								</div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" ng-click="saveEdit('wxapp')">确定</button>
