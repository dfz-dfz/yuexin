...
<ul class="nav nav-tabs">
		...
		<li <?php  if($do == 'buypackage') { ?> class="active"<?php  } ?>><a href="<?php  echo url('shop/buypackage');?>">增值业务</a></li>
...
<div class="account-box">
	<div class="clearfix">
		<iframe style="width: 966px; height:380px" src="<?php  if($_W['setting']['copyright']['payhost']) { ?>http://<?php  echo $_W['setting']['copyright']['payhost'];?><?php  } else { ?><?php  echo $_W['siteroot'];?><?php  } ?>/web/index.php?c=shop&a=payhost&username=<?php  echo $_W['username'];?>" marginheight="0" marginwidth="0" frameborder="0" width="100%" style="height:380px;background: #fff;" scrolling="auto" allowTransparency="true"></iframe>
	</div>
</div>
