...
<div class="clearfix table-responsive">
	...
	<div class="alert alert-success alert-dismissable">
				...
				<a href="http://help.012wz.com/index.php?category-view-21" target="_blank" style="border-radius: 4px;width: 84%;padding: 8px;font-size: 14px;background-color: #00bc0c;border-color: #00bc0c;color: #FFF">相关详细教程</a>
	</div>
