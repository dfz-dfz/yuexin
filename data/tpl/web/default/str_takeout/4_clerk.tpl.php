			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<label class="radio-inline"><input type="radio" value="1" <?php  if($clerk['is_sys'] == 1) { ?>checked<?php  } ?> name="is_sys"> 是</label>
						<label class="radio-inline"><input type="radio" value="0" <?php  if(!$clerk['is_sys']) { ?>checked<?php  } ?> name="is_sys"> 否</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<input type="text" name="email" value="<?php  echo $clerk['email'];?>" class="form-control">
