				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu color-gray" role="menu">
							...
							<li class="divider"></li>
							<?php  if(permission_check_account_user('see_system_upgrade')) { ?><li><a href="<?php  echo url('cloud/up');?>" target="_blank"><i class="wi wi-update color-gray"></i> 自动更新</a></li><?php  } ?>
	...
	<div class="panel-body clearfix main-panel-body <?php  if(!empty($_W['setting']['copyright']['leftmenufixed'])) { ?>menu-fixed<?php  } ?>">
		...
		<div class="left-menu">
			...
			<div class="left-menu-content">
				<?php  unset($frames['section']['wxplatform']['menu']['extension_module']);?>
				<?php  unset($frames['section']['wxplatform']['menu']['system_subscribe_subscribe']);?>
				<?php  unset($frames['section']['wxplatform']['menu']['system_service_display']);?>
