    ...
    <div class="mui-content mc-we7-home">
        ...
        <ul class="mui-table-view mui-table-view-chevron" style="margin: 2rem 0.6rem;border-radius: 0.6rem;">
            <li class="mui-table-view-cell">
                <a <?php  if($storeId) { ?> href="./index.php?i=<?php echo $_GPC['i']?>&c=entry&sid=<?php echo $storeId ?>&do=address&mode=2&m=str_takeout&at=1"<?php  } else { ?>href="./index.php?i=<?php echo $_GPC['i']?>&c=entry&do=index&m=str_takeout" <?php } ?> class="mui-navigate-right">
                    收货地址
                </a>
            </li>
