...
<div class="mui-content">
	<input type="hidden" value="<?php  echo $register_mode;?>" id="register_mode">
	<div id="sendcode">
		<div class="mui-content-padded mui-text-muted">请输入<?php  if($register_mode == 'mobile') { ?>手机号<?php  } else if($register_mode == 'email') { ?>邮箱<?php  } else { ?>手机号/邮箱<?php  } ?>,以收取验证码</div>
		<div class="mui-input-group mui-mt15">
			<div class="mui-input-row mui-help">
				<input name="username" type="text" class="js-mobile-val" placeholder="<?php  if($register_mode == 'mobile') { ?>手机号<?php  } else if($register_mode == 'email') { ?>邮箱<?php  } else { ?>手机号/邮箱<?php  } ?>"/>
			</div>
		</div>
	...
	<div id="codeverify" style="display:none;">
		<div class="mui-content-padded mui-text-muted">您的请输入<?php  if($register_mode == 'mobile') { ?>手机号<?php  } else if($register_mode == 'email') { ?>邮箱<?php  } else { ?>手机号/邮箱<?php  } ?><span class="mui-text-success"></span>会收到一条含有6位数字验证码的短息</div>
		<div class="mui-input-group mui-mt15">
			<div class="mui-input-row mui-help">
